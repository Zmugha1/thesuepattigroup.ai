...
window.LISTINGS = [
  {
    ...
    price: "$795,000",
    status: "sold",
    headline: "SOLD · CLOSED JULY 17, 2026",
    subheadline: "Congratulations to our clients on a successful sale.",
    cta: "Looking to sell? Call Jason today.",
    badge: "SOLD",
    closing_date: "July 17, 2026",
  ...
  },
  {
    ...
    price: "$2,200,000",
    status: "active",
    headline: "EXCLUSIVE ESTATE · PRIVATE SHOWINGS",
    ...
    cta: "Please reach out for a private showing.",
